...
export default function TaskCard({ title, status, priority, dueDate, assigneeName, onEdit, onDelete }: TaskCardProps) {
    ...
    return (
        <div className="group p-4 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl hover:shadow-md hover:border-blue-500/50 transition-all">
